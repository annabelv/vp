<?php
	class Photoupload {
		...
		public function create_file_name($photo_name_prefix) {
		...
		public function add_watermark($watermark_file) {
			...
			$wm_x = imagesx($this->new_temp_photo) - $wm_w - 10; //lahutame paremast servast watermark'i laiuse pluss 10 pikslit, et ei oleks kohe servas
			$wm_y = imagesy($this->new_temp_photo) - $wm_h - 10;
			imagecopy($this->new_temp_photo, $watermark, $wm_x, $wm_y, 0, 0, $wm_w, $wm_h);
			imagedestroy($watermark); //enam pole watermark'i vaja
		}
